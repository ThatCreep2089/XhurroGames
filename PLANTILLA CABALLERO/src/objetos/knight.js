export default class Knight extends Phaser.GameObjects.Sprite {
	...
	constructor(scene, x, y) {
		...
		this.isAttacking = false; //Flag que servirá para comprobar si se está haciendo un ataque
	...
	/**
	 * Función para consultar la propiedad isAttacking, aunque podriamos acceder directamente a ella ya que no tenemos propiedades privadas.
	 * @returns isAttacking
	 */
	isAttackInProcess(){
	...
	/**
	 * Devolvemos el collider a su posición y tamaño originales.
	 */
	resetCollider(){
		this.body.width = this.bodyWidth;
		this.body.setOffset(this.bodyOffset, 0);
